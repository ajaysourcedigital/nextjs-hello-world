...
Click the button below to deploy this app on Render.
 ...
 [![Deploy to PandaStack](https://dashboard.pandastack.io/deploy-button.svg)](https://dashboard.pandastack.io/deploy?repo=ajaysourcedigital/nextjs-hello-world&type=static&buildCmd=npm+run+build&outputDir=dist)
